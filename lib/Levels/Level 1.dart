...
class _Level1State extends State<Level1> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Level 1', style: TextStyle(fontSize: 25)),
          centerTitle: true,
          ...
          child: ConstrainedBox(
            ...
            child: Center(
              child: Column(
                children: [
                  SizedBox(height: 40),
                  Text('First, Lets learn how to say:',
                      style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height: 10),
                  Text('Basic Words', style: TextStyle(fontSize: 24)),
                  ...
                  SizedBox(height: 50),
                  Text('"Please"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Bitte”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  ...
                  SizedBox(height: 30),
                  Text('"Thank You"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Danke”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                  ...
                  SizedBox(height: 50),
                  Text('"GoodBye"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  ...
                  SizedBox(height: 30),
                  Text('"Sorry"', style: TextStyle(fontSize: 22)),
                  SizedBox(height: 20),
                  Text('“Leid”',
                      style:
                      TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
